...
mesh.current.position.y +=
  (targetY - mesh.current.position.y) * 0.042;
  });
  ...
  <Reveal delay={0.1}>
    <HoverCard style={featuredExperienceCard}>
      ...
      <ul style={experienceList}>
        ...
        <li>
          Collaborated with researchers to translate problem statements
...
<Reveal delay={0.1}>
  <HoverCard style={secondaryExperienceCard}>
    ...
    <ul style={{ marginTop: "1rem", lineHeight: 1.7, opacity: 0.8 }}>
      <li>
        Worked on data analysis and problem framing using simulated
        business scenarios.
      </li>
      <li>
        Applied analytical thinking and GenAI tools to generate insights
        and recommendations.
      </li>
    </ul>
  </HoverCard>
    ...
    >
      <HoverCard style={featuredProjectCard}>
        ...
        <p style={featuredProjectDesc}>
          A health analytics project built around Apple Watch and Apple Health
          data, looking at activity patterns to suggest when to rest or push
          harder.
        </p>
      </HoverCard>
    </a>
    ...
    {[
      {
        ...
        desc:
          "Evaluation framework for analyzing behavioral responses and limitations of large language models.",
        link: "https://github.com/Shashankdotio/llm-therapist-evaluation-"
      },
      {
        title: "VeriNews",
        desc:
          "NLP-based system for detecting misinformation in Hindi news articles.",
        link: "https://github.com/Shashankdotio/VeriNews--Hindi-fake-news-detector"
      },
      {
        title: "Eye Disease Classification",
        desc:
          "Medical imaging project using deep learning embeddings to classify eye conditions.",
...
<section style={contactSectionMinimal}>
  <div style={contactLayout}>
    ...
    <div>
      ...
      <Reveal delay={0.1}>
        <p style={contactText}>
          If you’d like to talk about data, machine learning, or potential
...
const tiltWrapper = {
  ...
  overflow: "hidden",   
  transition:
    "transform 0.2s cubic-bezier(.2,.8,.2,1), box-shadow 0.2s ease",
